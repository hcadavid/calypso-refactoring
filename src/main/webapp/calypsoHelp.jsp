...
<f:view>
    ...
    <div align="left" style="padding-left:2cm; padding-right:2cm;">
        ...
        <a href="faces/tutorial.jsp">Tutorial</a>.

        
        <h1>Workflows</h1>
        Learn how to identify outliers, compare groups of samples and assess the impact of
        environmental variables on the community composition by reading the
        <a href="faces/workflow.jsp">Calypso Workflows</a>.

        <h1>Slides</h1>
        Some slides describing the Calypso software can be obtained from <a href="resources/calypso-slides.pdf" target="_blank">here</a>.
